export const logTemplates = {
  system: [
    // Routine & Maintenance
    { type: "INFO", icon: "✅", msg: "System maintenance cycle completed. No anomalies detected." },
    { type: "INFO", icon: "📊", msg: "Daily data synchronization finished. Integrity: 100%." },
    ...
    { type: "WARNING", icon: "⚠️", msg: "Minor system instability detected. Monitoring..." },
    { type: "ERROR", icon: "❌", msg: "Critical error. Immediate attention required." },
  ],
  life_event: [ // Merged Main Quest & Achievement
  ...
  daily_task: [ // Merged Side Quest & Routine World Events
    ...
    { type: "TRANSACTION", icon: "💰", msg: "Financial Transaction Processed: " },
    { type: "TRAVEL", icon: "✈️", msg: "Zone Transition / Travel Complete: " },
    { type: "OPTIONAL", icon: "❔", msg: "Optional Activity Recorded: " },
  ],
  challenge: [ // Merged Combat & Struggles
    { type: "VICTORY", icon: "⚔️", msg: "Challenge Overcome. Experience Gained." },
    ...
    { type: "HEALTH", icon: "❤️‍🩹", msg: "Health Anomaly Detected. Recovery needed." },
  ],
  environment: [ // Purely Environmental
